    ...
    <div class="row">
      <div class="col-2 p-0">
        <div
            ...
            class="m-2"><img v-bind:src="thisBeer.image_url" class="img-fluid p-3"
                             style="max-width: 200px; max-height: 300px" alt="Responsive image"></div>
      </div>
      <div class="col-10">
          ...
          <div class="row">
            <div class="col-6">
              <div class="row text-light"
                   style="margin-left: 15px; margin-right: 15px; background-image: radial-gradient( circle farthest-corner at -4% -12.9%,  rgba(74,98,110,1) 0.3%, rgba(30,33,48,1) 90.2% ); border-radius: 10px">
                <div class="col-12" v-for="(item, index) in thisBeer.method.mash_temp" v-bind:item="item"
                     v-bind:index="index" :key="item">
                  <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="row text-light mt-2"
                   style="margin-left: 15px; margin-right: 15px; background-image: radial-gradient( circle 610px at 5.2% 51.6%,  rgba(5,8,114,1) 0%, rgba(7,3,53,1) 97.5% );; border-radius: 10px"
                   v-for="(value, name) in thisBeer.ingredients" :key="value">
