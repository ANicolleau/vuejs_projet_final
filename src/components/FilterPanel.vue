		...
		<div class="col-6 text-start text-light">
			<div class="row align-items-center" style="height: 83px">
				<div class="col-6">
					...
					<select class="dropdown-menu-dark w-100" v-model="selected">
